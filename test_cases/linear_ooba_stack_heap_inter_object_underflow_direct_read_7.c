 ...
 * Variant: target declared after origin, distance is negated before checking, target reached by reading using an auxiliary pointer, target accessed by reading using constants
 */
