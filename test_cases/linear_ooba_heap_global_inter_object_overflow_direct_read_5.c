 ...
 * Variant: target declared after origin, distance is negated before checking, target reached by reading using an index, target accessed by reading using constants
 */
