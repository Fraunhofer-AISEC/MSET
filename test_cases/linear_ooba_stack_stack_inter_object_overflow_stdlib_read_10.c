 ...
 * Variant: target declared before origin, distance is checked as it is, target reached by stdlib reading using an auxiliary pointer, target accessed by stdlib reading using auxiliary variables
 */
