 ...
 * Variant: target declared after origin, distance is checked as it is, target reached by writing using an auxiliary pointer, target accessed by writing using auxiliary variables, global auxiliary variables, declared first
 */
