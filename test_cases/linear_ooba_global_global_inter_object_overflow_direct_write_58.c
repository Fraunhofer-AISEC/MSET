 ...
 * Variant: target declared before origin, distance is negated before checking, target reached by writing using an auxiliary pointer, target accessed by writing using auxiliary variables, stack auxiliary variables, declared last
 */
