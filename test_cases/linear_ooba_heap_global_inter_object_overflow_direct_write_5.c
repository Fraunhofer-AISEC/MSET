 ...
 * Variant: target declared after origin, distance is checked as it is, target reached by writing using an index, target accessed by writing using constants, stack auxiliary variables, declared last
 */
