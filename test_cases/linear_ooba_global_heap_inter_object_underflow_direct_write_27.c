 ...
 * Variant: target declared after origin, distance is negated before checking, target reached by writing using an auxiliary pointer, target accessed by writing using constants, global auxiliary variables, declared last
 */
