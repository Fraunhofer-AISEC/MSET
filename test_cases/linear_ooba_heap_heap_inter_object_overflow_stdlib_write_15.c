 ...
 * Variant: target declared after origin, distance is negated before checking, target reached by stdlib writing using an index, target accessed by stdlib writing using constants, global auxiliary variables, declared last
 */
