 ...
 * Variant: target declared before origin, distance is checked as it is, target reached by stdlib writing using an index, target accessed by stdlib writing using auxiliary variables, global auxiliary variables, declared last
 */
