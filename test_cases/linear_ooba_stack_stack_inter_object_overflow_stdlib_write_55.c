 ...
 * Variant: target declared before origin, distance is negated before checking, target reached by stdlib writing using an index, target accessed by stdlib writing using constants, stack auxiliary variables, declared first
 */
