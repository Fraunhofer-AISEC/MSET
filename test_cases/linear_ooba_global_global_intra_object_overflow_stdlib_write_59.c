 ...
 * Variant: target declared before origin, distance is checked as it is, target reached by stdlib writing using an auxiliary pointer, target accessed by stdlib writing using constants, stack auxiliary variables, declared last
 */
